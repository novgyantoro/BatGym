...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT * FROM tbl_member WHERE username = ? AND password = ?");
            ...
            if (rsu.next()) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("coba.jsp?id=" + rsu.getInt("id"));
